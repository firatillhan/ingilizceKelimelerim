...
class LearnedViewController: UIViewController {
    ...
    func learnedKelimelerAll() {
           ...
           let url = URL(string: "https://www.swiftogreniyorum.com/kelimeler/learned_kelimeler.php")!
    ...
    func kelimeCikar(kelime_id:Int) {
       //öğrendiğim kelimeler listesinden kelimeyi çıkarır
...
extension LearnedViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "learnedHucre", for: indexPath) as! LearnedHucreTableViewCell
